...
class ProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = Profile
        fields = '__all__'  # Puedes personalizar los campos según necesites
        # Ejemplo de fields personalizado:
        # fields = ['id', 'user', 'telefono', 'direccion', 'foto']
        extra_kwargs = {
            'user': {'read_only': True}  # El usuario debería ser de solo lectura
        }
